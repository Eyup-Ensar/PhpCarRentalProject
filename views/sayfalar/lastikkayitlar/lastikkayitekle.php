...
<div  style="width:100%;">
  <div class="container mt-3 mb-3">
    ...
    <form method="post" action="<?php echo URL."/lastikkayitlar/lastikkayitEkleSon"?>">
      <div class="mb-3 mt-3">
      ...
      <div class="mb-3">
        ...
        <input type="date" name="lastik_degisim_tarihi" class="form-control">
      </div>
      <div class="mb-3">
        <label>AKS Ve Yer Bilgisi:</label>
        <input type="text" name="aks_yerbilgisi" class="form-control">
      </div>
      <div class="mb-3">
        <label>Çıkarılan Lastik:</label>
        <input type="text" name="cikarilan_lastik" class="form-control">
      </div>
      <div class="mb-3">
        <label>Takılan Lastik:</label>
        <input type="text" name="takilan_lastik" class="form-control">
      </div>
      <div class="mb-3">
        <label>Gönderilen Depo:</label>
        <input type="text" name="gonderilern_depo" class="form-control">
      </div>
      <div class="mb-3">
        <label>Ücret:</label>
        <input type="number" name="ucret" class="form-control">
      </div>
      <div class="d-grid">
