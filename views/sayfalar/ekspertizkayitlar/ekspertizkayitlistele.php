<?php require "views/header.php"; ?>
    ...
    ?>
    <?php if (isset($veri["ekspertizkayitlar"])) : ?>
    <?php 

      if(isset($veri["sorgu"])):
        Session::set("excelekspertizkayitsorgu", $veri["sorgu"]);
      endif;
      ...
      if(isset($veri["ekspertizkayitarama"])) {
        $ayir = explode("-", $veri["ekspertizkayitarama"]);
        if(count($ayir)>=4){
          $parca = explode("_", $veri["arama"]);
          $tarih1 = $parca[0];
          $tarih2 = $parca[1];
        }else {
          $search = $veri["ekspertizkayitarama"];
        }
      }

      $optValues = ["arac_id", "ekspertiz_bayi", "ekspertiz_tarihi", "aciklama"];

      $optNames = ["Araç", "Ekspertiz Bayi", "Ekspertiz Tarihi", "Açıklama"];
  ...
  <div style="width:100%; padding: 10px; margin-top:10px">
      <div class="row mb-2 d-flex align-items-center">  
          ...
          <div class="col-4 col-md-6 d-xxl-none text-end">
            <div class="dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                <li><a class="dropdown-item" href="<?php echo URL; ?>/ekspertizkayitlar/ekspertizkayitEkle">Ekspertiz Kayıt Ekle</a></li>
                <li>
                    <a type="submit" class="dropdown-item" href="<?php echo URL; ?>/ekspertizkayitlar/ekspertizkayitlarExcelAl">Excel Çıktısı Al</a>
                </li>
              </ul>
            </div>
          </div>
          <div class="col-12 col-xxl-4 col-md-6  mb-2 mb-xxl-0 mt-3 mt-xxl-0 pe-md-3">
            <form action="<?php echo URL."/ekspertizkayitlar/ekspertizkayitArama" ?>" method="post">
          ...
          <div class="col-12 col-xxl-3 col-md-6 mb-2 mb-xxl-0 mt-3 mt-xxl-0 ps-md-3">
            <form action="<?php echo URL."/ekspertizkayitlar/ekspertizkayitSirala" ?>" method="post">
              <div class="input-group">
      ...
      <table class="table">
        ...
        <?php 
          ...
          $kontrol = 0;
          echo "<tbody>";
          foreach($veri["ekspertizkayitlar"] as $value):
                echo '<tr class="tbodytd" id="'.$value['id'].'">';
                  ...
                  echo '<td>'.$value["ekspertiz_bayi"].'</td>';
                  echo '<td>'.date("d.m.Y", strtotime($value["ekspertiz_tarihi"])).'</td>';
                  echo '<td>'.$value["aciklama"].'</td>';
          ?>
          <td class="d-flex justify-content-evenly">
            <a onclick="silmedenSor('<?php echo URL.'/ekspertizkayitlar/ekspertizkayitSil/'.$value['id']; ?>'); return false" class="mr-2">
              <form method="post">
            ...
            <a href="<?php echo URL; ?>/ekspertizkayitlar/ekspertizkayitGuncelle/<?php echo $value['id']?>">
      ...
      <?php 
        if(isset($veri["ekspertizkayitarama"]) && isset($veri["aramatercih"])) : 
          $link = '/ekspertizkayitlar/ekspertizkayitArama/'.$Harici->seo($veri["aramatercih"]).'/'.$Harici->seo($veri["ekspertizkayitarama"]).'/';
        elseif(isset($veri["siralamakriteri"]) && isset($veri["siralamatercih"])):
          $link = '/ekspertizkayitlar/ekspertizkayitSirala/'.$Harici->seo($veri["siralamakriteri"]).'/'.$Harici->seo($veri["siralamatercih"]).'/';
        else:
          $link = '/ekspertizkayitlar/ekspertizkayitListele/';
        endif;
