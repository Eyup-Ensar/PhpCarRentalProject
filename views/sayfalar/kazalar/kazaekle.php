...
<div  style="width:100%;">
  <div class="container mt-3 mb-3">
    ...
    <form method="post" action="<?php echo URL."/kazalar/kazaEkleSon"?>" enctype="multipart/form-data">
      <div class="mt-3">
        <label>Kaza Fotoğraflarını Yükle:</label>
        <div class="inputfileadd sira-1">
          <input type="file" accept="image/*" name="kazafoto[]" class="form-control kazafotoupload" value="fotoğraf seç">
          <div class="inputfileadd sira-2"></div>
        </div>
      </div>
      ...
      <div class="mb-3">
        ...
        <input type="date" name="kaza_tarihi" class="form-control">
      </div>
      <div class="mb-3">
        <label>Servis Adı:</label>
        <input type="text" name="servis_adi" class="form-control">
      </div>
      <div class="mb-3">
...
<script src="<?php echo URLdesign; ?>/views/design/js/fotodesign.js"></script>
