...
<div  style="width:100%;">
  <div class="container mt-3 mb-3">
    ...
    <form method="post" action="<?php echo URL."/servisler/servisEkleSon"?>">
      <div class="mb-3 mt-3">
      ...
      <div class="mb-3">
        ...
        <input type="text" name="servis_bayi_adi" class="form-control">
      </div>
      <div class="mb-3">
        <label>Yapılan İşlem:</label>
        <input type="text" name="yapilan_islem" class="form-control">
      </div>
      <div class="mb-3">
        <label>İşlem Nedeni:</label>
        <input type="text" name="islem_nedeni" class="form-control">
      </div>
      <div class="mb-3">
        <label>Servis Giriş Tarihi:</label>
        <input type="date" name="servis_giris_tarihi" class="form-control">
      </div>
      <div class="mb-3">
        <label>Servis Çıkış Tarihi:</label>
        <input type="date" name="servis_cikis_tarihi" class="form-control">
      </div>
      <div class="mb-3">
        <label>Servis Giriş KM:</label>
        <input type="number" name="servis_giris_km" class="form-control">
      </div>
      <div class="mb-3">
        <label>Servis Tutarı:</label>
        <input type="number" name="servis_tutari" class="form-control">
      </div>
      <div class="d-grid">
