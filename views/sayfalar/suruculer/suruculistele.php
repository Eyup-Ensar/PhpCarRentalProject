<?php require "views/header.php"; ?>
    ...
    ?>
    <?php if (isset($veri["suruculer"])) : ?>
    <?php 

      if(isset($veri["sorgu"])):
        Session::set("excelsurucusorgu", $veri["sorgu"]);
      endif;
      ...
      if(isset($veri["surucuarama"])) {
        $ayir = explode("-", $veri["surucuarama"]);
        if(count($ayir)>=4){
          $parca = explode("_", $veri["surucuarama"]);
          $tarih1 = $parca[0];
          $tarih2 = $parca[1];
        }else {
          $search = $veri["surucuarama"];
        }
      }

      $optValues = ["ad", "soyad", "telefon", "mail_adresi", "belge_turu", "belge_numarasi", "belge_skt"];

      $optNames = ["Ad", "Soyad", "Telefon", "Mail Adresi", "Belge Türü", "Belge Numarası", "Belge SKT"];
  ...
  <div style="width:100%; padding: 10px; margin-top:10px">
      <div class="row mb-2 d-flex align-items-center">  
          ...
          <div class="col-4 col-md-6 d-xxl-none text-end">
            <div class="dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                <li><a class="dropdown-item" href="<?php echo URL; ?>/suruculer/surucuEkle">Ceza Ekle</a></li>
                <li>
                    <a type="submit" class="dropdown-item" href="<?php echo URL; ?>/suruculer/suruculerExcelAl">Excel Çıktısı Al</a>
                </li>
              </ul>
            </div>
          </div>
          <div class="col-12 col-xxl-4 col-md-6  mb-2 mb-xxl-0 mt-3 mt-xxl-0 pe-md-3">
            <form action="<?php echo URL."/suruculer/surucuArama" ?>" method="post">
          ...
          <div class="col-12 col-xxl-3 col-md-6 mb-2 mb-xxl-0 mt-3 mt-xxl-0 ps-md-3">
            <form action="<?php echo URL."/suruculer/surucuSirala" ?>" method="post">
              <div class="input-group">
          ...
          <div class="d-none d-xxl-block col-xxl-2 text-end">
            <div class="dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                <li><a class="dropdown-item" href="<?php echo URL; ?>/suruculer/surucuEkle">Sürücü Ekle</a></li>
                <li>
                    <a type="submit" class="dropdown-item" href="<?php echo URL; ?>/suruculer/suruculerExcelAl">Excel Çıktısı Al</a>
                </li>
              </ul>
        ...
        <?php 
          ...
          foreach($veri["suruculer"] as $value):
                echo '<tr class="tbodytd" id="'.$value['id'].'">';
                  ...
                  echo '<td>'.$value["mail_adresi"].'</td>';
                  echo '<td>'.$value["belge_turu"].'</td>';
                  echo '<td>'.$value["belge_numarasi"].'</td>';
                  echo '<td>'.date('d.m.Y', strtotime($value['belge_skt'])).'</td>';
          ?>
          <td class="d-flex justify-content-evenly">
            <a onclick="silmedenSor('<?php echo URL.'/suruculer/surucuSil/'.$value['id']; ?>'); return false" class="mr-2">
              <form method="post">
            ...
            <a href="<?php echo URL; ?>/suruculer/surucuGuncelle/<?php echo $value['id']?>">
      ...
      <?php 
        if(isset($veri["surucuarama"]) && isset($veri["aramatercih"])) : 
          $link = '/suruculer/surucuArama/'.$Harici->seo($veri["aramatercih"]).'/'.$Harici->seo($veri["surucuarama"]).'/';
        elseif(isset($veri["siralamakriteri"]) && isset($veri["siralamatercih"])):
          $link = '/suruculer/surucuSirala/'.$Harici->seo($veri["siralamakriteri"]).'/'.$Harici->seo($veri["siralamatercih"]).'/';
        else:
          $link = '/suruculer/surucuListele/';
        endif;
