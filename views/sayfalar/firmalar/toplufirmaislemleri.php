...
<div class="container-fluid mt-4 mt-4">
  ...
  <div class="row">
    <div class="col-xl-12 col-md-12 text-center"> 
      ...
      <!-- TOPLU ÜRÜN EKLEME -->
      <?php if(isset($veri["topluFirmaEkleme"])): ?>
    ...
    <div class="col-xl-12 col-md-12 mb-12 border-left-mvc text-left p-2 mb-2 navigasyonunanasi">
        <a href="<?php echo URL ?>/firmalar/firmaListele" class="navigasyon">FİRMALAR</a> 
        / Toplu Firma Ekleme
    </div>
          ...
          <div class="col-xl-4 col-md-8 mx-auto">
            <div class="row bg-gradient-beyazimsi">
              ...
              <div class="col-12 formeleman nocizgi mvc-renk form-check">
                <form action="<?php echo URL."/firmalar/toplufirmaEkle/son" ?>" enctype="multipart/form-data" class="form" method="post">
              </div>
