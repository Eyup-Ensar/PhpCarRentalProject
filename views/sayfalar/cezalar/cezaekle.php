...
<div  style="width:100%;">
  <div class="container mt-3 mb-3">
    ...
    <form method="post" action="<?php echo URL."/cezalar/cezaEkleSon"?>">
      <div class="mb-3 mt-3">
      ...
      <div class="mb-3">
        ...
        <input type="date" name="ceza_tarihi" class="form-control">
      </div>
      <div class="mb-3">
      ...
      <div class="mb-3">
        ...
        <input type="date" name="son_odeme_tarihi" class="form-control">
      </div>
      <div class="mb-3">
        <label>Ceza Açıklama:</label>
        <input type="text" name="ceza_aciklama" class="form-control">
      </div>
      <div class="mb-3">
        <label>Durum:</label>
      ...
      <div class="mb-3">
        ...
        <input type="number" name="ceza_tutari" class="form-control">
      </div>
      <div class="d-grid">
